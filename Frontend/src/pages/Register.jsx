  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://digitalidentihubbackend-5vzo.vercel.app/auth/user/register",
        {
          method: "POST",
    ...
    <div className="auth-background flex items-center justify-center px-4">
      <div className="card-elevated max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-slt-blue mb-2">
            Create Your IdentityHub Account
          </h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          ...
          <div className="flex items-start">
            <input
              ...
              onChange={handleInputChange}
              className={`h-4 w-4 text-slt-green focus:ring-slt-green-500 border-gray-300 rounded mt-1 focus-ring ${
                formErrors.agreeToTerms ? "border-red-500" : ""
              }`}
              aria-invalid={!!formErrors.agreeToTerms}
              aria-describedby={
                formErrors.agreeToTerms ? "agreeToTerms-error" : undefined
              }
            />
